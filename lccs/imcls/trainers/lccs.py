...
class AbstractLCCS(Vanilla):
    ...
    def initialization_stage(self):
        ...
        # this part is not allowed in practice:
        # the client does not have access on a support test set for
        # coefficient calculation. Our approach needs to initialize
        # these variables randomely
